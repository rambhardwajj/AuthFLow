          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            {user ? (
              ...
              <>
                ...
                <Button variant="outline" size="lg" className="hover:bg-zinc-100/90">
        ...
        <div className="lg:w-1/2 grid sm:grid-cols-2 gap-6">
          <Card className="text-center bg-zinc-800 border-0 shadow-md hover:shadow-xl transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-red-50 text-base">Secure Auth</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-red-100 text-sm">
                Supports custom login and Google OAuth for strong, flexible authentication.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center bg-zinc-800 border-0 shadow-md hover:shadow-xl transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-red-50 text-base">Session Control</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-red-100 text-sm">
                Track, manage, and revoke sessions across multiple devices with ease.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center bg-zinc-800 border-0 shadow-md hover:shadow-xl transition-shadow sm:col-span-2">
            <CardHeader>
              ...
              <CardTitle className="text-red-50 text-base">Admin Tools</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-red-100 text-sm">
                Manage users with role-based access, audit logs, and session visibility.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
